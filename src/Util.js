...
Util.prototype = {
	...
	calculateStationsPercentages: function(stationPositions, trackName) {
		var stations = [];
		for (var stationPositionNo in stationPositions) {
	...
	findClosestLine: function(point, trackName, trainId) {
		...
		for (var i = 0; i < distances.length; i++) {
			...
			if (typeof smallestDistanceIndices[0] === 'undefined' || smallestDistanceIndices[0] === null && typeof smallestDistanceIndices[1] === 'undefined' || smallestDistanceIndices[1] === null && typeof smallestDistanceIndices[2] === 'undefined' || smallestDistanceIndices[2] === null) {
